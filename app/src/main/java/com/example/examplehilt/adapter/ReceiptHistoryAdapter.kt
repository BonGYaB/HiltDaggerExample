package com.example.examplehilt.adapter
...
class ReceiptHistoryAdapter: RecyclerView.Adapter<ReceiptHistoryAdapter.TipHistoryResultHolder>() {
    private var tipHistoryList = emptyList<ReceiptHistory>()
    ...
    fun setData(tip: List<ReceiptHistory>){
    ...
    inner class TipHistoryResultHolder(private val view: View): RecyclerView.ViewHolder(view) {
        ...
        fun setData(tipHistory: ReceiptHistory) {
        ...
        private fun dialogTipReview(context: Context, tipHistory: ReceiptHistory): Dialog{
